...
<a href="citas.php" class="btn btn-secondary w-100">
...
<a href="agregar_cita.php" class="btn btn-success w-100">
...
<a
href="editar_cita.php?id=<?php echo $fila['id']; ?>"
...
<a
href="eliminar_cita.php?id=<?php echo $fila['id']; ?>"
